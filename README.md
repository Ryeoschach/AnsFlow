...
- [ ] 🔄 **拖拽式流水线编辑器** - 可视化步骤编辑和依赖关系配置
- [ ] 🔄 **步骤配置表单组件** - 7种原子步骤的参数设置界面
- [ ] 🔄 **项目管理界面** - 项目创建、环境配置、成员管理
